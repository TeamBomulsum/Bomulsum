...
<head>
<meta charset="UTF-8">
<title>보물섬 작가홈 | 판매 일시중지 작품</title>
<link
			...
			<tr>
				...
				<td><button id="update" type="button" onClick="location.href ='<c:url value='/writer/workRegister.wdo'/>'">수정</button></td>
					...
					<div class="bottomLine">
						<button class="button" id="saleStart" type="button">판매 시작</button>
...
$(document).ready(function(){
    ...
    function pauseSale(data){   
        $.ajax({
           url:"/bomulsum/writer/salesStartArt.wdo",
           data:data,
           success : function(){
              alert('변경에 성공했습니다.');
...
<c:forEach var="i" items='${pauseOnSale}'>
