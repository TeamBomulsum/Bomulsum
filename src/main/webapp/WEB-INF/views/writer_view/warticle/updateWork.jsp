...
$(document).ready(function() {
	...
	<c:forEach var="i" items="${updateArtInfoList}">
	   ...
	   $('#wWeight').val('${i.artInfoDetailWeight}');
	   $('#wProduce').val('${i.artInfoDetailFrom}');
	   $('#wIngredient').val('${i.artInfoDetailMaterial}');
	   $('#wDate').val('${i.artInfoDetailExpdate}');
	   $('#wManage').val('${i.artInfoDetailMust}');
	   $('#wConfig').val('${i.artInfoDetailComponent}');
	   $('#wManual').val('${i.artInfoDetailWay}');
	</c:forEach>
	//이미 저장되어진 값 - 옵션
                  ...
                  <tr>
                     ...
                     <td>
                        <div>
                           <div class="flexcontainer">
                              <div class="textTitle">
                                 <input type="text" name="artOptionCategory" id="option1" placeholder="구성 선택" autocomplete="off">
                              </div>
                           </div>
                           <!-- end flexcontainer -->
