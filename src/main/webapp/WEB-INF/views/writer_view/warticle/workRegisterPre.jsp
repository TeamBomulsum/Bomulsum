...
<head>
<meta charset="UTF-8">
<title>보물섬 작가홈 | 작품등록</title>

<link href="<c:url value='/resources/vendor/fontawesome-free/css/all.min.css'/>" href="<c:url value='/resources/vendor/clockpicker-gh-pages/src/clockpicker'/>" type="text/css">
            ...
            <!-- form 시작 -->
               ...
               <table border="1" class="jeongabasicInfoTable">
                  ...
                  <tr>
                     ...
                     <td>
                     <input type="file" required="required" id="image" accept="image/*" name="artPicture"
                  ...
                  <tr>
                     ...
                     <td>
                          <input type="text" id="workName" name="artName" required="required" style="max-height: 30px" maxlength="20" autocomplete="off" />
							<span id="nameCounter" style="font-size: 12px"> ### </span></td>
                  </tr>
                  <tr>
                     <td class="left">가격</td>
                     <td><input type="number" id="workPrice" name = "artPrice" required="required" autocomplete="off">&nbsp;원</td>
                  </tr>
                  <tr>
                     <td class="left">할인</td>
                     <td><input type="number" id="salePrice"  required="required" autocomplete="off">&nbsp;원</td>
                  </tr>
                  <tr>
                     <td class="left">수량</td>
                     <td><input type="number" required="required" id="num" name = "artAmount" autocomplete="off"> 개</td>
                  </tr>
                  <tr>
                     <td class="left">작품설명</td>
                     <td>
                     <textarea id="summernote" required="required"  style="overflow-y: scroll; resize: none;" type="text">
                     </textarea>
                     </td>
                  </tr>
                     ...
                     <td>
                        ...
                        <div class="infoBox" style="border: 1px solid #ddd; padding:15px; margin-top:2%; width:85%">
                           <div id="weight" >
                              ...
                              <input type="text" required="required" name="artInfoDetailWeight" id=wWeight size="78%" autocomplete="off">
                           </div>
                           <!-- end weight -->
                           <div id="produce" style="margin-top:1%">
                              <label>생산자 및 소재지</label><br> 
                              <input type="text" required="required" name="artInfoDetailFrom" id=wProduce size="78%" autocomplete="off">
                           </div>
                           <!-- end produce -->
                           <div id="ingredient" style="margin-top:1%">
                              <label>원재료명 및 함량</label><br> 
                              <input type="text" required="required" name="artInfoDetailMaterial" id=wIngredient size="78%" autocomplete="off">
                           </div>
                           <!-- end ingredient -->
                           <div id="date" style="margin-top:1%">
                              <label>제조년월일, 유통기한 또는 품질 유지기한</label><br> 
                              <input type="text" required="required" name="artInfoDetailExpdate" id=wDate size="78%" autocomplete="off">
                           </div>
                           <!-- end date -->
                           <div id="manage" style="margin-top:1%">
                              <label>관리법상 표시사항</label><br> 
                              <input type="text" required="required" name="artInfoDetailMust" id=wManage size="78%" autocomplete="off">
                           </div>
                           <!-- end manage -->
                           <div id="config" style="margin-top:1%">
                              <label>구성</label><br> 
                              <input type="text" required="required" name="artInfoDetailComponent" id=wConfig size="78%" autocomplete="off">
                           </div>
                           <!-- end config -->
                           <div id="manual" style="margin-top:1%">
                              <label>보관방법 또는 취급방법</label><br> 
                              <input type="text" required="required" name="artInfoDetailWay" id=wManual size="78%" autocomplete="off">
                           </div>
                           <!-- end manual -->
                  ...
                  <tr>
                     ...
                     <td>
                        <div>
                           <div class="flexcontainer">
                              <div class="textTitle">
                                 <input type="text" required="required" name="artOptionCategory" id="option1" placeholder="구성 선택" autocomplete="off">
                              </div>
                           </div>
                           <!-- end flexcontainer -->
                        ...
                        <div>
                           <div class="flexCon">
                              <div class="nameGroup" style="margin-left:3%">
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name1" size="30%" autocomplete="off">
                                 </div>
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name2" size="30%" autocomplete="off">
                                 </div>
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name3" size="30%" autocomplete="off">
                                 </div>
                              </div>
                              <div class="priceGroup" style="margin-left:9%">
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price1" size="30%" autocomplete="off">
                                 </div>
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price2" size="30%" autocomplete="off">
                                 </div>
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price3" size="30%" autocomplete="off">
                                 </div>
                  ...
                  <tr>
                     ...
                     <td>
                        <div>
                           <div class="flexcontainer">
                              <div class="textTitle">
                                 <input type="text" name="artOptionCategory" required="required" id="option2" placeholder="구성 선택" autocomplete="off">
                              </div>
                           </div>
                           <!-- end flexcontainer -->
                        ...
                        <div>
                           <div class="flexCon">
                              <div class="nameGroup" style="margin-left:3%">
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name4" size="30%" autocomplete="off">
                                 </div>
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name5" size="30%" autocomplete="off">
                                 </div>
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name6" size="30%" autocomplete="off">
                                 </div>

                              </div>
                              <div class="priceGroup" style="margin-left:9%">
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price4" size="30%" autocomplete="off">
                                 </div>
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price5" size="30%" autocomplete="off">
                                 </div>
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price6" size="30%" autocomplete="off">
                                 </div>
                              </div>
                           </div>
                           <!-- end flexcon -->
                    ...
                    <tr>
                     ...
                     <td>
                        <div>
                           <div class="flexcontainer">
                              <div class="textTitle">
                                 <input type="text" required="required" name="artOptionCategory" id="option3" placeholder="구성 선택" autocomplete="off">
                              </div>
                           </div>
                           <!-- end flexcontainer -->
                        ...
                        <div>
                           <div class="flexCon">
                              <div class="nameGroup" style="margin-left:3%">
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name7" size="30%" autocomplete="off">
                                 </div>
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name8" size="30%" autocomplete="off">
                                 </div>
                                 <div class="names">
                                    <label>이름</label> &nbsp;<input type="text" required="required" name="artOptionName" id="name9" size="30%" autocomplete="off">
                                 </div>

                              </div>
                              <div class="priceGroup" style="margin-left:9%">
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price7" size="30%" autocomplete="off">
                                 </div>
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price8" size="30%" autocomplete="off">
                                 </div>
                                 <div class="prices">
                                    <label>가격</label> &nbsp;<input type="text" required="required" name="artOptionPrice" id="price9" size="30%" autocomplete="off">
                                 </div>
                              </div>
                           </div>
                           <!-- end flexcon -->
...
$(document).ready(function() {
	  ...
	  $(".note-editable").attr('name', 'artDescription');
});
...
var i = 0;
	function saveWork(event){
		...
		let noteEditable = document.getElementsByClassName('note-editable');
		let artDescription = document.getElementsByName('artDescription');
		console.log(artDescription.text);
		var keywordValue='';
		...
		console.log(noteEditable.value);
		...
		let categoryI = document.getElementById('categoryId');
		...
		if(salePrice.value == ''){
			salePrice.value = 0;
			console.log(workPrice.value);
		}
		
		if(num.value == ''){
			alert('작품 개수는 0개 이상입니다.')
			num.focus();
			return false;
		}
		...
		if(categoryI.value == 'nulll'){
			alert('카테고리를 정해주세요.');
			categoryI.focus();
			return false;
		}
		if(wWeight.value == ''){
			alert('포장단위별 용량, 수량을 등록해 주세요.');
			wWeight.focus();
			return false;
		}
		if(wProduce.value == ''){
			alert('생산자 및 소재지를 등록해 주세요.');
			wProduce.focus();
			return false;
		}
		if(wIngredient.value == ''){
			alert('원재료 및 함량을 등록해 주세요.');
			wIngredient.focus();
			return false;
		}
		if(wDate.value == ''){
			alert('제조년월일,기한을 등록해 주세요.');
			wDate.focus();
			return false;
		}
		if(wManage.value == ''){
			alert('관리법상 표시사항을 등록해 주세요.');
			wManage.focus();
			return false;
		}
		if(wConfig.value == ''){
