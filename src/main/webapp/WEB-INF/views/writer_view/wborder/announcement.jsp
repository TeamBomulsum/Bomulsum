...
<script src="<c:url value='/resources/vendor/jquery/jquery.min.js'/>"></script>
  ...
  <link href="<c:url value='/resources/vendor/datatables/dataTables.bootstrap4.min.css' /> " rel="stylesheet">
	...
	$(function(){
		...
		$('.writer_announcement_detail').click(function() {
        ...
        <!-- modal -->
         ...
         <div class="modal-dialog modal-lg" role="document" style="max-width:1000px;">
            <div class="modal-content">
               ...
               <div style="display: flex; height: 50px; margin:0px 30px 6px 30px; border-bottom: 1px solid #d9d9d9; align-items: center; ">
                   <h6 style="font-weight: bold; font-size: 13px; margin: 0px;">카테고리:&nbsp;&nbsp; </h6>
                   <div id="staticBackdropCategory" style="font-weight: bold; font-size: 13px;"></div>
               </div>
