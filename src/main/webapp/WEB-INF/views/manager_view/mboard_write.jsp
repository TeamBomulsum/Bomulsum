		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseUtilities"> <i
					class="fas fa-fw fa-wrench"></i> <span>매출/쿠폰</span>
			</a>
				<div id="salseNcoupone" class="collapse"
					aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="#">매출통계</a> <a
							class="collapse-item" href="#">쿠폰</a>
					</div>
				</div></li>
						...
						<div class="card-body">
							...
							<form>
								<div>
									...
									<br>
									<div>
										<span>글 카테고리&nbsp;&nbsp;:&nbsp;&nbsp;</span> <span> <select
											name="board_type">
												<option value="notice">공지사항</option>
												<option value="question">자주 묻는 질문</option>
												<option value="guide">이벤트</option>
												<option value="guide">판매 / 정책 가이드(작가용)</option>
										</select>
										</span>
									</div>
									<br>
									<div>
										<span>글 제목&nbsp;&nbsp;:&nbsp;&nbsp;</span> <span><input
									...
									<br>
									<div>
										<input type="submit" value="등록" class="minwoo_mboard_btn">
									</div>
								</div>
							</form>
						</div>
