...
<div class="dainheader-middle">
   <div class="dainheader-middle-inner">
      ...
      <div style="height: 100%; width: 105px; margin-right: 10px"><img alt="logo" src="Logo_blue.png" height="100%" style="margin-right: 50px"></div>
      ...
      <!--  
         <button class="dainiconbtn"><i class="fa fa-user-o fa-2x" aria-hidden="true" ></i></button>
         <p>MY정보</p>
         -->
               <div style="height: 42px; width: 40px; margin-right: 20px;">
                  <button class="dainiconbtn" style="padding:0px;"><i class="fa fa-user fa-2x" aria-hidden="true" ></i>
                  <p style="margin: 0px; font-size: 10px; width: 40px">MY정보</p></button>
               </div>
               <div style="height: 42px; width: 40px;">
                  <button class="dainiconbtn" style="padding:0px;"><i class="fa fa-shopping-cart fa-2x" aria-hidden="true" ></i>
                  <p style="margin: 0px; font-size: 10px; width: 40px">장바구니</p></button>
               </div>
               <!-- <td style="height: 42px; padding-top: 3px;"><button class="dainiconbtn"><img alt="cart" src="cart.png" height="27px"></button></td> -->
      </div>
   </div>
</div>
<!-- Header 하단 메뉴영역 -->
